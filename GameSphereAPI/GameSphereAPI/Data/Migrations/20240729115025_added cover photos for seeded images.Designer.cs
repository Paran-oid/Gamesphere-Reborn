...
namespace GameSphereAPI.Migrations
{
    ...
    [Migration("20240729115025_added cover photos for seeded images")]
    partial class addedcoverphotosforseededimages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameSphereAPI.Models.Site_Models.Game_Related.Game", b =>
                {
                    ...
                    b.Property<List<string>>("PicturesPaths")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PicturesPaths = new List<string> { "/GameImages/stellaris.jpg", "/path/to/picture2.jpg" },
                            Price = 49.99m,
                        ...
                        new
                        {
                            ...
                            PicturesPaths = new List<string> { "/GameImages/hoi4.jpg", "/path/to/picture4.jpg" },
                            Price = 39.99m,
            ...
            modelBuilder.Entity("GameSphereAPI.Models.Site_Models.Game_Related.Relationships.GameGenre", b =>
                {
            ...
            modelBuilder.Entity("GameSphereAPI.Models.Site_Models.Game_Related.Relationships.GameLanguage", b =>
                {
            ...
            modelBuilder.Entity("GameSphereAPI.Models.Site_Models.Game_Related.Relationships.GamePublisher", b =>
                {
                    ...
                    b.ToTable("GamePublishers", "gam");
                });

            modelBuilder.Entity("GameSphereAPI.Models.Site_Models.Game_Related.Relationships.GameTag", b =>
                {
            ...
            modelBuilder.Entity("GameSphereAPI.Models.User.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "72084c71-e724-4eb2-aa76-f5c1027626b7",
                            ...
                            SecurityStamp = "fd2fa932-8d3a-4af1-9089-a9784d0e3ef1",
                            Summary = "A gamer",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b821f49f-758e-4764-b907-53747926104d",
                            ...
                            SecurityStamp = "0e06f444-eb35-40e0-bc49-6cdfdf7e9083",
            ...
            modelBuilder.Entity("GameSphereAPI.Models.User.Relationships.UserAchievement", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameSphereAPI.Models.User.Relationships.UserDLC", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameSphereAPI.Models.User.Relationships.UserGame", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameSphereAPI.Models.User.Relationships.UserGroup", b =>
                {
            ...
            modelBuilder.Entity("GameSphereAPI.Models.User.Relationships.UserNotification", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameSphereAPI.Models.Site_Models.Game_Related.Relationships.GamePublisher", b =>
                {
                    ...
                    b.HasOne("GameSphereAPI.Models.Site_Models.Game_Related.Publisher", "Publisher")
                        .WithMany("GamePublishers")
                        .HasForeignKey("PublisherID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GameSphereAPI.Models.User.Relationships.UserAchievement", b =>
                {
                    ...
                    b.HasOne("GameSphereAPI.Models.User.Relationships.UserGame", "Game")
                        .WithMany("Achievements")
                        .HasForeignKey("GameID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
